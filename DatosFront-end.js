...
Guardar() {  // Esto va a guardar una peli
...
xhr.open('POST', 'https://cine89.herokuapp.com/api/nuevapelicula');
...
xhr.send(JSON.stringify(objetoaenviar));   
 ...
 Modificar() {  // Para modificar un dato
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://cine89.herokuapp.com/api/Modificapelicula');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
...
xhr.send(JSON.stringify(objetoaenviar));   
    ...
    Eliminar() {  // Para eliminar un dato
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://cine89.herokuapp.com/api/Eliminapelicula');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
...
Seleccionartodos() {  // Esto va a seleccionar todolos los elementos que hayan
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://cine89.herokuapp.com/api/seleccionartodos');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
...
xhr.send(JSON.stringify(objetoaenviar));   
    ...
    Seleccionarporfecha() {  // Segun la fecha va a buscar los elementos
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://cine89.herokuapp.com/api/seleccionarporfecha');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
...
xhr.send(JSON.stringify(objetoaenviar));   
    ...
    Seleccionarporid() {  // Para llamar a los obj por el ID
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://cine89.herokuapp.com/api/seleccionarpeliculaporid');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
...
xhr.send(JSON.stringify(objetoaenviar));   
    ...
    Seleccionarpornombre() {  // Acá selecciona por medio de los datos
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://cine89.herokuapp.com/api/seleccionarpornombre');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
...
xhr.send(JSON.stringify(objetoaenviar));   
   ...
   peliculaspormesyanno(mes,anno)
            { // Va a recoger el año y mes ingresado
                var objetoaenviar = this; // Lo iguala a sí mismo
                ...
                return new Promise(function(resolve,reject){
                   ...
                   try{
                       var xhr = new XMLHttpRequest();
                       xhr.open('POST','https://cine89.herokuapp.com/api/seleccionarpelicula');
                       xhr.setRequestHeader('Content-Type', 'application/json');
                       xhr.onload = function(){
                            if(xhr.status === 200){
                                ...
                                for(var elemento in peliculas){
                                    ...
                                    if((fechadelapelicula.getMonth()+1 == mes) && (fechadelapelicula.getFullYear() == anno)){ // Este ciclo recoge los datos
...
let imagenenbase64 = "";  // Guarda la imagen y la convierte en texto
      $("#imgpeli").change(function(){
       readURL(this);
        ...
        function readURL(input) {
            ...
            // Definir cada uno de los asientos en el cine.
        ...
        function botonguardarclick() // Ingresa los datos a la base de MongoDB
            {
